...
func doNotAllowBadKeysLogs() {
	...
	klog.InfoS("Starting container in a pod", "测试", "containerID")              // want `Key positional arguments "测试" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	klog.ErrorS(nil, "Starting container in a pod", "测试", "containerID")        // want `Key positional arguments "测试" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	klog.InfoS("Starting container in a pod", " test", "containerID")           // want `Key positional arguments " test" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	klog.ErrorS(nil, "Starting container in a pod", " test", "containerID")     // want `Key positional arguments " test" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	klog.InfoS("Starting container in a pod", "test ", "containerID")           // want `Key positional arguments "test " are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	klog.ErrorS(nil, "Starting container in a pod", "test ", "containerID")     // want `Key positional arguments "test " are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	klog.InfoS("Starting container in a pod", "test test", "containerID")       // want `Key positional arguments "test test" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	klog.ErrorS(nil, "Starting container in a pod", "test test", "containerID") // want `Key positional arguments "test test" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	klog.InfoS("Starting container in a pod", "t*est", "containerID")           // want `Key positional arguments "t\*est" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	klog.ErrorS(nil, "Starting container in a pod", "t*est", "containerID")     // want `Key positional arguments "t\*est" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	klog.InfoS("Starting container in a pod", "test[0]", "containerID")         // want `Key positional arguments "test\[0\]" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	klog.ErrorS(nil, "Starting container in a pod", "test[0]", "containerID")   // want `Key positional arguments "test\[0\]" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	klog.InfoS("Starting container in a pod", "T", "containerID")               // want `Key positional arguments "T" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	klog.ErrorS(nil, "Starting container in a pod", "T", "containerID")         // want `Key positional arguments "T" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	klog.InfoS("Starting container in a pod", "Test", "containerID")            // want `Key positional arguments "Test" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	klog.ErrorS(nil, "Starting container in a pod", "Test", "containerID")      // want `Key positional arguments "Test" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	...
	logger.Info("Starting container in a pod", "测试", "containerID")              // want `Key positional arguments "测试" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	logger.Error(nil, "Starting container in a pod", "测试", "containerID")        // want `Key positional arguments "测试" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	logger.WithValues("测试", "containerID")                                       // want `Key positional arguments "测试" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	logger.Info("Starting container in a pod", " test", "containerID")           // want `Key positional arguments " test" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	logger.Error(nil, "Starting container in a pod", " test", "containerID")     // want `Key positional arguments " test" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	logger.WithValues(" test", "containerID")                                    // want `Key positional arguments " test" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	logger.Info("Starting container in a pod", "test ", "containerID")           // want `Key positional arguments "test " are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	logger.Error(nil, "Starting container in a pod", "test ", "containerID")     // want `Key positional arguments "test " are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	logger.WithValues("test ", "containerID")                                    // want `Key positional arguments "test " are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	...
	logger.Error(nil, "Starting container in a pod", "test test", "containerID") // want `Key positional arguments "test test" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	logger.WithValues("test test", "containerID")                                // want `Key positional arguments "test test" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	logger.Info("Starting container in a pod", "t*est", "containerID")           // want `Key positional arguments "t\*est" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	logger.Error(nil, "Starting container in a pod", "t*est", "containerID")     // want `Key positional arguments "t\*est" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	logger.WithValues("t*est", "containerID")                                    // want `Key positional arguments "t\*est" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	logger.Info("Starting container in a pod", "test[0]", "containerID")         // want `Key positional arguments "test\[0\]" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	logger.Error(nil, "Starting container in a pod", "test[0]", "containerID")   // want `Key positional arguments "test\[0\]" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	logger.WithValues("test[0]", "containerID")                                  // want `Key positional arguments "test\[0\]" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	logger.Info("Starting container in a pod", "T", "containerID")               // want `Key positional arguments "T" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	logger.Error(nil, "Starting container in a pod", "T", "containerID")         // want `Key positional arguments "T" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	logger.WithValues("T", "containerID")                                        // want `Key positional arguments "T" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	logger.Info("Starting container in a pod", "Test", "containerID")            // want `Key positional arguments "Test" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	logger.Error(nil, "Starting container in a pod", "Test", "containerID")      // want `Key positional arguments "Test" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
	logger.WithValues("Test", "containerID")                                     // want `Key positional arguments "Test" are expected to be alphanumeric and start with either one lowercase or two uppercase letters. Please refer to https://github.com/kubernetes/community/blob/master/contributors/devel/sig-instrumentation/migration-to-structured-logging.md#name-arguments.`
